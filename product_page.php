                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        for (var i = 0; i < no_of_items; i++) {
                            ...
                            $("#some_container").append('<div class="w3-third"><div class="w3"><br/><img id="thumbnail1" src="' + imagelink + '" style="width:250px;"><div class="w3-container" id="product_name"><h6>PRODUCT NAME: ' + product_name + '</h6><h6 style="font-weight: bold">PRICE: ' + price_currency + " " + price_amount + '</h6><h6 id="brand' + i + '">BRAND: ' + brand + '</h6><h6 id="color' + i + '">COLOR: </h6><h6>CONDITION: ' + condition + '</h6><h6>CATEGORY: ' + category + '</h6><h6>MERCHANT: ' + merchant + '</h6><div>View Count: 99</div><a href="' + link + '"><button class="w3-button w3-block w3-border">More Information</button></a><br/></div></div></div>');
                            if ($("#brand" + i).val() === "") {
                                $("#brand" + i).hide();
                            }
                            if ($("#color" + i).val() === "") {
...
//                            var data = {merchant_id: 1, name: product_name, price_amount: price_amount, price_currency, brand: brand, color: color, condition: condition, category: category, image_url: imagelink, item_more_info_url: link };
//                            $.ajax({
//                                type: "POST",
